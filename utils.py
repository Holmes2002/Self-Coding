...
from dataset import build_customs_semi_loader, build_customsloader
import logging

logger = logging.getLogger("global")


def get_loader(cfg,args,split):
    train_loader_sup, train_loader_unsup = build_customs_semi_loader("train", cfg, args)
    val_loader = build_customs_semi_loader("val", cfg,args)
